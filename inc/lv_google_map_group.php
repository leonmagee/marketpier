	...
	private function generate_map_lat_lng() { ?>
        ...
        <script>
            function initMap() {
                ...
                function getLatLngAddress(latlngArray, array_length, geo, listing_price = null) {
                    ...
                    if (count < array_length) {
                        ...
                        for (var index = 0; index < array_length; ++index) {
                            ...
                            var marker = new google.maps.Marker({
                                ...
                                //icon: goldStar,
                                icon: squareBg,
                                label: {text: current_price, color: '#FFF', fontWeight: '700', fontFamily: 'Open Sans', fontSize: '11px'},
                                map: map
                            });
